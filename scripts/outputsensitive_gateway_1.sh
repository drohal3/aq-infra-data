...
certificate_pem=$(terraform output -raw certificate_pem_gateway_1)
...
private_key=$(terraform output -raw private_key_gateway_1)
...
public_key=$(terraform output -raw public_key_gateway_1)
